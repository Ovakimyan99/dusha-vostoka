...
const cardsEvents = [
    ...
    {id: 'salad-4', name: 'ЦЕЗАРЬ С КРИВЕТКАМИ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Салат Романо, креветки жареные, сыр Пармезан, помидоры Черри, яйцо перепелиное, соус'},
    {id: 'salad-5', name: 'РУККОЛА С КРЕВЕТКАМИ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Салат руккола, креветки жареные, сыр Пармезан, помидоры Черри, соус'},
    {id: 'salad-6', name: 'МЯСНОЙ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Вырезка говяжья, огурцы свежие, помидоры Черри, микс - салат, сыр Пармезан, соус'},
    ...
    {id: 'salad-13', name: 'ТЕПЛЫЙ ФЛАМБЕ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Печень куриная, микс - салат, кедровый орех, апельсин, вино красное, соус медово - горчичный'},
    ...
    {id: 'salad-15', name: 'КАПРЕЗЕ С МОЦАРЕЛОЙ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'помидоры, микс - салат, сыр Моцарелла, бальзамический соус, базилик, соус Песто'},
    ...
    {id: 'cold-snacks-2', name: 'АССОРТИ БРУСЕТТА', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Багет черный, куриное филе, помидоры Бакинские, лосось с/с, Моцарелла, зелень, соус Песто, масло оливковое, бальзамический соус'},
    {id: 'cold-snacks-3', name: 'РЫБНОЕ АССОРТИ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Лосось с/с, палтус х/к, масляная рыба, х/к, лимон, оливки, маслины, зелень'},
    ...
    {id: 'hot-snack-7', name: 'КУТАБЫ С ЗЕЛЕНЬЮ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Руккола, шпинат, мята, петрушка, кинpа, лук зеленый'},
    ...
    {id: 'hot-snack-14', name: 'КРЕВЕТКИ ТИГРОВЫЕ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Креветки, чеснок, на выбор: соус ким - чи, соус соевый, вино белое'},
    ...
    {id: 'first-meal-2', name: 'БОРЩ МОСКОВСКИЙ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Капуста б/к, свекла, морковь, лук репчатый, перец болгарский, томат, говядина, чеснок, зелень'},
    ...
    {id: 'first-meal-6', name: 'УХА ПО - БРАКОНЬЕРСКИ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Филе сазана, стебель сельдерея, морковь, картофель, перец зеленый, лук порей, лимон, зелень'},
    ...
    {id: 'first-meal-8', name: 'ХАРЧО', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Баранина, хмели - сунели, аджика, томат, рис'},
    ...
    {id: 'second-hot-dishes-8', name: 'ЛОСОСЬ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Лосось, лимон, овощи, микс - салат, зелень, соус Наршараб'},
    ...
    {id: 'second-hot-dishes-13', name: 'ТЕЛЯТИНА ТЕРИЯКИ', img: './img/news/zaglushka.png', alt: '', title: '', text: 'Телятина, кабачки, лук красный, чеснок, соус терияки, зелень'},
